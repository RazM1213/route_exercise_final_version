from consts.consts import TEXT_FILE_EXTENSION
...
class FileSavingTests(TestBase):
    def test_valid_file_name_capitalized(self):
        ...
        self.assertEqual([f"{generated_input[STUDENT_DETAILS][FIRST_NAME].title()}_{generated_input[STUDENT_DETAILS][LAST_NAME].title()}{TEXT_FILE_EXTENSION}"], self.get_docs(expected_docs=1))
